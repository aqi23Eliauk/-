		...
		<view class="container">
			<scroll-view scroll-y="true">
				<view class="search-search">
					...
					<text class="iconfont icon-guanbi1" v-show="searchType != 1" @tap="handlaToClose"></text>
				</view>
				<block v-if="searchType === 1">
					<view class="search-history">
						...
						<view class="search-history-list">
							<view v-for="(item,index) in searchHistory" :key="index" @tap="handeToWord(item)">{{item}}
							</view>
						</view>
					</view>
					<view class="search-hot">
						...
						<view class="search-hot-item" v-for="(item, index) in searchHot" :key="index"
							@tap="handeToWord(item.searchWord)">
				...
				<block v-else-if="searchType === 2">
					<view class="search-result">
						<view class="search-result-item" v-for="(item, index) in searchList" :key="index" @tap="handleToDetaill(item.id)">
				...
				<block v-else-if="searchType === 3">
					 <view class="search-suggest">
						...
						<view class="search-suggest-item" v-for="(item, index) in searchSuggest" :key="index" @tap="handeToWord(item.keyword)">
